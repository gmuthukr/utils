...
then
	...
	ovs-vsctl set Interface dpdk0 other_config:pmd-rxq-affinity="0:16" \
		...
		-- set Interface dpdk1 other_config:pmd-rxq-affinity="0:18" \
		-- set Interface dpdkvhostclient0 other_config:pmd-rxq-affinity="0:18"
else
	ovs-vsctl set Interface dpdk0 other_config:pmd-rxq-affinity="0:18" \
		-- set Interface dpdkvhostclient1 other_config:pmd-rxq-affinity="0:18" \
